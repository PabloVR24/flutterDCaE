...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.value)  return 'Formato debe ser Cero o un Numero Entero Positivo';
    if (displayError == StockError.format)  return 'Formato debe ser Cero o un Numero Entero Positivo';
  ...
  StockError? validator(int value) {
    ...
    if(!passwordRegExp.hasMatch(isInteger.toString())) return StockError.format;
